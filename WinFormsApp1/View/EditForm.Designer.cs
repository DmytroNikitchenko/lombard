namespace lombard.View
{
    partial class EditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            EditItemButton.Font = new Font("Segoe UI", 14.25F, FontStyle.Regular, GraphicsUnit.Point, 204);
            EditItemButton.Location = new Point(629, 378);
            EditItemButton.Name = "EditItemButton";
            EditItemButton.RightToLeft = RightToLeft.No;
            EditItemButton.Size = new Size(159, 60);
            EditItemButton.TabIndex = 0;
            EditItemButton.Text = "Редагувати запис";
